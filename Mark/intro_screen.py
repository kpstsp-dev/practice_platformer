...
class IntroScreen:
    def __init__(self, screen_width, screen_height):
        ...
        # Текст заставки
        self.game_title = "МОЙ ПЛАТФОРМЕР"
        self.creator_name = "Создатель: Марк"
